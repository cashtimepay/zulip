...
type ActionPopoverContext = {
    ...
    should_display_quote_to_new_topic: boolean;
...
export function get_actions_popover_content_context(message_id: number): ActionPopoverContext {
    ...
    const should_display_quote_to_new_topic =
        not_spectator && message.type === "stream" && Boolean(move_message_menu_item);
    ...
    return {
        ...
        should_display_quote_to_new_topic,
    };
}
